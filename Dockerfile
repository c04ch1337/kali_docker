...
RUN apt update && apt upgrade -y &&     apt install -y kali-linux-default openssh-server metasploit-framework nmap     net-tools curl wget smbclient python3 python3-pip git dnsutils ftp     postfix mailutils mutt &&     apt clean
